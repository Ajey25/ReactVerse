...
export function Projects() {
  ...
  return (
    <section
      id="projects"
      className="relative z-10 py-5 bg-gradient-to-b from-black/40 to-black/20"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ amount: 0.2 }}
          className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12"
        >
          {projects.map((p) => (
            <motion.div
              key={p.title}
            ...
            >
              <div className="relative h-65 bg-white/10 rounded-md overflow-hidden">
                <img
                  src={p.image}
                  alt={p.title}
